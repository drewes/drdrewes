  ...
  return (
    <div className="bg-white">
      <div className="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:py-24 lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
        <div>
          <h2 className="text-base font-semibold tracking-wide uppercase text-pink-dark">
            Optimise your health
          </h2>
          <p className="mt-2 text-3xl font-extrabold text-gray-900 font-display">
            Targeted interventions that impact your well-being
          </p>
          <p className="mt-4 text-lg text-gray-500">
            We offer a range of targeted treatments. Our clinicians
            will assess you and based on your profile suggest applicable
            options.
          </p>
        </div>
